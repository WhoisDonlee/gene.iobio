...
cp $working_dir/server/views/index.html $working_dir/deploy/index.html
cp $working_dir/client/data $working_dir/deploy/data
cp $working_dir/client/assets $working_dir/deploy/assets
cp $working_dir/client/js/thirdparty $working_dir/deploy/js/thirdparty
cp $working_dir/client/app/third-party $working_dir/deploy/app/third-party
cp $working_dir/client/dist/build.js $working_dir/deploy/dist/build.js
cp $working_dir/client/dist/build.js.map $working_dir/deploy/dist/build.js.map
